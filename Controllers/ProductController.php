...
function FindAll($objectProduct) {
    ...
    $arrayReturn = array();
    $arrayReturn['countAll'] = $objectProduct->FindCountAll();
    $arrayReturn['pageAll'] = ceil($arrayReturn['countAll'] / $objectProduct->__get('limit'));
    $arrayReturn['count'] = count($return);
    $arrayReturn['page'] = $objectProduct->__get('page');
    $arrayReturn['data'] = $return;
